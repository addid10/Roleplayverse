...
<?php if(isset($_SESSION['coloseum_code']) && $_SESSION['coloseum_name'] == "CCC"): ?>
...
<head>
    ...
    <link rel="stylesheet" href="css/colosseum.css?v=2">
</head>
                ...
                <div class="col-lg-6 mx-auto">
                    <div class="pb-4 text-center">
                        <div class="title-content">
                            <h2 class="text-white text-uppercase">CCC</h2>
                            ...
                            <div id="information04" class="collapse">
                                <div class="card-body">
                                    ...
                                    <div class="container-bar">
                                        <div class="skills ccc-attack">0%</div>
                                    </div>

                                    <p class="mb-0 mt-2">Defense</p>
                                    <div class="container-bar">
                                        <div class="skills ccc-defense">0%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
